...
function generateInvoiceTable(doc, invoice) {
    ...
    generateTableRow(
        ...
        "ShippingFee",
        "",
        formatCurrency(invoice.shippingFee * 100)
    );

    const vatPosition = paidToDatePosition + 20;
    generateTableRow(
        doc,
        vatPosition,
        "",
        ...
        "VAT",
        "",
        formatCurrency(invoice.VAT * 100)
    );

    const couponPosition = vatPosition + 20;
    generateTableRow(doc, couponPosition, "", "", "Coupon", "", invoice.coupon);
